...
class LoginViewModel extends Cubit<LoginStates>{
  ...
  TextEditingController emailController = TextEditingController(text:'aliaa@gmail.com');
  TextEditingController passwordController = TextEditingController(text: 'Aliaa1234@');
